...
This is a paragraph after the JSON frontmatter
that should be joined into a single line.
...
This is a [link to example.com](https://example.com) in a paragraph
that should be preserved when formatting.

This is a paragraph with [multiple](https://example.com) [links](https://example.org)
that should all be preserved.

## Inline Math

This paragraph contains inline math $E = mc^2$ that should be preserved
when formatting.

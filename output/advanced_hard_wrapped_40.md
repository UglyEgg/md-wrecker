...
~~strikethrough text~~ that should be
preserved.

Multiple ~~strikethrough~~ elements in
a ~~single paragraph~~ should all be
preserved.

## Emoji Shortcodes

This paragraph contains emoji shortcodes
like :smile: and :heart: that
should be preserved.

Multiple emoji :wink: :tada:
:rocket: in a single paragraph should
all be preserved.

Mixed text with emoji :thumbs_up: and
regular text.

## Autolinks

This paragraph contains an autolink
https://example.com that should be preserved.

Multiple autolinks https://google.com and
https://github.com in a paragraph.

Mixed with regular links: [explicit link](https://example.com) and
...
| across multiple lines in the source | | Item 2 | Another description with | multiple lines |

## Combined Elements

This paragraph has [links](https://example.com),
~~strikethrough~~, emoji :smile:,
and autolinks https://github.com all in one.

Task lists in paragraphs: - [x]
completed and - [ ] pending items.

Mixed HTML <span>inline</span> with
other elements.
...
Here's a complex example with all
elements:
...
Final paragraph with :smile: emoji,
[links](https://example.com), ~~strikethrough~~, and

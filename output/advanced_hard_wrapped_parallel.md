...
Multiple ~~strikethrough~~ elements in a ~~single paragraph~~ should all be
preserved.

## Emoji Shortcodes

This paragraph contains emoji shortcodes like :smile: and :heart: that
should be preserved.

Multiple emoji :wink: :tada: :rocket: in a single paragraph should
all be preserved.
...
This paragraph has [links](https://example.com), ~~strikethrough~~, emoji :smile:, and
autolinks https://github.com all in one.
...
Final paragraph with :smile: emoji, [links](https://example.com), ~~strikethrough~~, and

...
This is a paragraph after the JSON frontmatter that should be joined into a single line.
...
This paragraph contains inline math $E = mc^2$ that should be preserved when formatting.

This paragraph contains multiple inline math elements $a^2 + b^2 = c^2$ and $F = G\frac{m_1 m_2}{r^2}$ that should all be preserved.
